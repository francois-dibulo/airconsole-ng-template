...
AirApp.services.factory('FileLoaderService', ['$http', '$q', function ($http, $q) {
...
*/
AirApp.directives.directive("exampleDirective", [function() {
  return {
    // E = element, A = attribute, C = class, M = comment
    restrict: 'EA',
    templateUrl: function(elem, attrs) {
      return attrs.templateUrl || 'views/controller/directives/_example_directive.html';
    },
    scope: {
